...
enum class OreBlocks(val block: OreBlock) {
    ...
    ORE_DIAMOND(OreBlock(OreData(1.0f, "diamond",3, ChunkItems.ORE_CHUNKS_DIAMOND.items.defaultInstance))),
    ...
    ORE_LIGNITE(OreBlock(OreData(1.0f, "lignite",3, ChunkItems.ORE_CHUNKS_LIGNITE.items.defaultInstance))),
    ...
    ORE_NATIVE_GOLD(OreBlock(OreData(1.0f, "native_gold",3, ChunkItems.ORE_CHUNKS_NATIVE_GOLD.items.defaultInstance))),
